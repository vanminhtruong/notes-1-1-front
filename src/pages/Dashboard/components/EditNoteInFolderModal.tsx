      ...
      <div className="min-h-[50px]">
        ...
        {activeTab === 'video' && (
          <div className="flex items-center gap-3">
            ...
            />
            {editNote.videoUrl && (
              <video src={editNote.videoUrl} className="w-16 h-16 rounded-md object-cover border" />
            )}
          </div>
        )}
...
const EditNoteInFolderModal = memo(({ isOpen, onClose, editNote, setEditNote, onSubmit, folderName }: EditNoteInFolderModalProps) => {
  ...
  if (!isOpen || !editNote) return null;
        ...
        <div className="flex items-center justify-between px-6 pt-6 pb-3 xl-down:px-5 xl-down:pt-5 xl-down:pb-2.5 lg-down:px-5 lg-down:pt-5 lg-down:pb-2.5 md-down:px-4 md-down:pt-4 md-down:pb-2 sm-down:px-3.5 sm-down:pt-3.5 sm-down:pb-2 xs-down:px-3 xs-down:pt-3 xs-down:pb-1.5">
          <div>
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
              {t('folders.inFolder')}: <span className="font-medium">{folderName}</span>
            </p>
          </div>
          <button
            onClick={onClose}
...
EditNoteInFolderModal.displayName = 'EditNoteInFolderModal';

export default EditNoteInFolderModal;
